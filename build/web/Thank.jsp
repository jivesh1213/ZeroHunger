<%-- 
    Document   : Thank
    Created on : 26 Jan, 2020, 10:32:12 AM
    Author     : lenovo
--%>
...
<style type="text/css">
	* {
    ...
    background-color:#ddd;
		background-image:url("Pictures/as.png");
		background-size: cover;
    margin: auto;
    margin-bottom: 100px;
		width: 50%;
...
<div id="contain">
    ...
    <div id="initiative">
        <div id="thanks" style="height: 650px"> </div>
</div>
...
<div id="contact">
	...
	<div id="clicks">
		<div>
			<div>
				<h5>ABOUT US</h5>
				<div><a href="http://localhost:8080/ZeroHunger-war/ourInitiative.jsp">Our Initiative</a></div><br>
